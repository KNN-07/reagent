...
import { type HighlightColors, highlightCode as nativeHighlightCode, supportsLanguage } from "@reagent/ra-natives";
import { type Component, Text } from "@reagent/ra-tui";
