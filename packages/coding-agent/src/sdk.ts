import {
	...
	INTENT_FIELD,
	type ThinkingLevel,
} from "@reagent/ra-agent-core";
import type { Message, Model } from "@reagent/ra-ai";

import { prewarmOpenAICodexResponses } from "@reagent/ra-ai/providers/openai-codex-responses";
import { SearchDb } from "@reagent/ra-natives";
 ...
 *
 * // With explicit model
 * import { getModel } from '@reagent/ra-ai';
 * const { session } = await createAgentSession({
