...
import { $env, getConfigDirName, getProjectDir, logger, postmortem, setProjectDir, VERSION } from "@reagent/ra-utils";
...
async function checkForNewVersion(currentVersion: string): Promise<string | undefined> {
	...
	try {
		const response = await fetch("https://registry.npmjs.org/@reagent/ra-coding-agent/latest");
