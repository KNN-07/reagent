...
import type { AssistantMessage, ImageContent, Message } from "@reagent/ra-ai";
import { Spacer, Text, TruncatedText } from "@reagent/ra-tui";
		...
		this.ctx.chatContainer.addChild(
			new Text(
				theme.bold(theme.fg("warning", "Update Available")) +
					...
					theme.fg("accent", "reagent update"),
				1,
				0,
			),
		);
