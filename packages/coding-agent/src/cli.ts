#!/usr/bin/env bun
import { APP_NAME, MIN_BUN_VERSION, VERSION } from "@reagent/ra-utils";
/**
 * CLI entry point — registers all commands explicitly and delegates to the
 * lightweight CLI runner from pi-utils.
 */
import { type CommandEntry, run } from "@reagent/ra-utils/cli";
...
async function showHelp(config: import("@reagent/ra-utils/cli").CliConfig): Promise<void> {
	const { renderRootHelp } = await import("@reagent/ra-utils/cli");
