 ...
 */
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel } from "@reagent/ra-agent-core";
import type {
	Api,
...
import type * as piCodingAgent from "@reagent/ra-coding-agent";
import type { SearchDb } from "@reagent/ra-natives";
import type { AutocompleteItem, Component, EditorComponent, EditorTheme, KeyId, TUI } from "@reagent/ra-tui";
...
export interface ExtensionAPI {
	...
	logger: typeof import("@reagent/ra-utils").logger;
