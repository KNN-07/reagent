...
import { type PendingExtensionRequest, requestRpcEditor } from "@reagent/ra-coding-agent/modes/rpc/rpc-mode";
import type { RpcExtensionUIRequest } from "@reagent/ra-coding-agent/modes/rpc/rpc-types";
