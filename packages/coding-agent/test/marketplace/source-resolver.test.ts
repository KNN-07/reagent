...
import type { MarketplacePluginEntry } from "@reagent/ra-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@reagent/ra-coding-agent/extensibility/plugins/marketplace";
