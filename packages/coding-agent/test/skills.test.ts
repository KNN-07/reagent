...
import { type Skill as CapabilitySkill, skillCapability } from "@reagent/ra-coding-agent/capability/skill";
import { getCapability } from "@reagent/ra-coding-agent/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "@reagent/ra-coding-agent/extensibility/skills";
