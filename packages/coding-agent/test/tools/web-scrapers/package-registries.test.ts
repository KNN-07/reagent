...
import { handleCratesIo } from "@reagent/ra-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@reagent/ra-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@reagent/ra-coding-agent/web/scrapers/hex";
import { handleNpm } from "@reagent/ra-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@reagent/ra-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@reagent/ra-coding-agent/web/scrapers/pypi";
