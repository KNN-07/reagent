...
import { handleArtifactHub } from "@reagent/ra-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@reagent/ra-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@reagent/ra-coding-agent/web/scrapers/discogs";
