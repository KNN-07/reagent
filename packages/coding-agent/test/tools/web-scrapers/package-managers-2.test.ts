...
import { handleChocolatey } from "@reagent/ra-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@reagent/ra-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@reagent/ra-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@reagent/ra-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@reagent/ra-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@reagent/ra-coding-agent/web/scrapers/terraform";
