...
import { handleCheatSh } from "@reagent/ra-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@reagent/ra-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@reagent/ra-coding-agent/web/scrapers/tldr";
