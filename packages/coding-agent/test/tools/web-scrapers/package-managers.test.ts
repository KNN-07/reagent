...
import { handleAur } from "@reagent/ra-coding-agent/web/scrapers/aur";
import { handleBrew } from "@reagent/ra-coding-agent/web/scrapers/brew";
import { handleMaven } from "@reagent/ra-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@reagent/ra-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@reagent/ra-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@reagent/ra-coding-agent/web/scrapers/rubygems";
