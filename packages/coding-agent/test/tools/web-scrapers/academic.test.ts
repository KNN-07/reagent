...
import { handleArxiv } from "@reagent/ra-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@reagent/ra-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@reagent/ra-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@reagent/ra-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@reagent/ra-coding-agent/web/scrapers/types";
