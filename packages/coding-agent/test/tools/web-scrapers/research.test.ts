...
import { handleBiorxiv } from "@reagent/ra-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@reagent/ra-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@reagent/ra-coding-agent/web/scrapers/wikidata";
