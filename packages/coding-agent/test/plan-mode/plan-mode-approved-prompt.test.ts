...
import { renderPromptTemplate } from "@reagent/ra-coding-agent/config/prompt-templates";
import planModeApprovedPrompt from "@reagent/ra-coding-agent/prompts/system/plan-mode-approved.md" with {
	type: "text",
};
