...
## Core component contract (`@reagent/ra-tui`)
...
```ts
import { replaceTabs, truncateToWidth } from "@reagent/ra-tui";
...
import { SelectList, matchesKey, replaceTabs, truncateToWidth } from "@reagent/ra-tui";
import { getSelectListTheme, type ExtensionAPI } from "@reagent/ra-coding-agent";
