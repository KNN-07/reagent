...
`@reagent/ra-natives` is a three-layer stack:
...
**Guaranteed contract (API-facing):** consumers import from `@reagent/ra-natives` and use typed wrappers.
...
1. Consumer imports from `@reagent/ra-natives`.
