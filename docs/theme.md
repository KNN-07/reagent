...
- syntax highlighting colors used by native highlighter (`@reagent/ra-natives`)
...
- default agent dir: `~/.reagent/agent`
- effective default file: `~/.reagent/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.reagent/agent/themes/my-theme.json`.
